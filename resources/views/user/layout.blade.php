        ...
        <div class="page-wrapper">
            ...
            <div class="page-header navbar navbar-fixed-top">
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="page-logo">
                        <a href="#">
                            <img src="../assets/layouts/layout/img/logo.svg" alt="logo" class="logo-default" width="100px" height="40px" /> </a>
                    ...
                    <div class="top-menu">
                      <ul class="nav navbar-nav pull-right">
                        <li class="dropdown">
                          <a href="{{ URL::route('user.logout') }}" class="dropdown-toggle" id="btn-logout">
                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-sidebar navbar-collapse collapse in">
                        ...
                        <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-closed " data-keep-expanded="true" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <!-- <li class="nav-item">
                                <a href="{{route('user.compras')}}" class="nav-link nav-toggle">
                                    <i class="fa fa-opencart"></i>
                                    <span class="title">Compras Realisadas</span>
                                </a>
                            </li> -->
                            <li class="nav-item">
                                <a href="{{route('user.redes')}}" class="nav-link nav-toggle">
                                    <i class="icon-list"></i>
            ...
            <div class="page-footer">
                <div class="page-footer-inner"> 2017 &reg; puzzle.lab
                </div>
...
<![endif]-->
        ...
        <script type="text/javascript" src="{{(asset('assets/global/plugins/js.cookie.min.js" type="text/javascript'))}}"></script>
